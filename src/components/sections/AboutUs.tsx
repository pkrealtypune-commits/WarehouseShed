  ...
  const services = [
    {
      ...
      desc: "Ready-to-use industrial sheds on rent in Pune so you can start operations quickly.",
      icon: <Warehouse className="text-blue-600" size={22} />,
      image: "/assets/warehouserentals1.avif"
    },
    {
      title: "Land & Plot Sales",
      desc: "Expert assistance in acquiring Industrial Land for Sale in Chakan and surrounding areas.",
      icon: <Map className="text-blue-600" size={22} />,
      image: "/assets/Developement1.avif"
    },
    {
      title: "Built-to-Suit",
      desc: "Custom industrial plot development in Pune based on your specific manufacturing needs.",
    ...
    <section id="about" className="py-16 md:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start mb-20 md:mb-24">
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-black text-slate-900 uppercase tracking-tighter leading-[1] mb-6">
              Industrial Land & <br className="hidden md:block" /> 
              <span className="text-blue-600">Warehouse Experts.</span>
            </h3>
            <div className="space-y-4 text-slate-600 font-medium text-base md:text-lg leading-relaxed mb-10">
              <p>
                Warehouseshed helps businesses find the right space without the headache. 
                With decades of experience, we specialize in helping businesses acquire <strong>Industrial Land for Sale in Chakan</strong> and <strong>MIDC Plots for Sale in Pune</strong> with 100% clear titles.
              </p>
              <p>
                Since 2018, we’ve matched global and local companies with properties that fit their 
                location, size, and budget perfectly across the Pune industrial corridor.
              </p>
            </div>

            {/* --- REALTY WORKS MANAGEMENT BADGE WITH LINK --- */}
            <motion.a 
              href="https://realtyworks.co.in"
              target="_blank"
              rel="noopener noreferrer"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-slate-50 p-5 rounded-2xl flex items-center gap-5 hover:bg-slate-100 transition-colors group cursor-pointer border border-transparent hover:border-slate-200"
            >
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ArrowRight size={14} className="text-blue-600 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                </div>
              </div>
            </motion.a>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              ...
              <ul className="space-y-4 md:space-y-6">
                {[
                  "Verified Industrial Plot for Sale in Pune listings",
                  "Expertise in MIDC and industrial land legalities",
                  "Direct access to prime warehouse on rent options",
                  "Transparent paperwork and hassle-free transfers"
                ].map((item, idx) => (
              ...
              <p className="mt-8 pt-6 border-t border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-[#fd610d]">
                Specializing in Industrial Land and MIDC Plots.
              </p>
            </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-[2rem] md:rounded-[3.5rem] p-8 md:p-16 text-center">
          ...
          <h3 className="text-2xl md:text-5xl font-black text-slate-900 uppercase tracking-tighter mb-10 md:mb-14">Acquire Land. <span className="text-blue-600">Hassle-free.</span></h3>
